...
use file_classification_core::service::tags::{
  delete_tags_by_conditions, delete_tags_by_ids, select_tag_by_group_id,
  select_tags_by_conditions_with_options, select_tags_by_conditions_with_pagination,
  select_tags_by_filter_with_options, select_tags_by_filter_with_pagination, update_tag_by_id,
};
...
async fn api_create_tag(
  ...
  match create_tag(&mut conn, &tag_dto) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("CREATE_TAG_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_update_tags_by_conditions(
  ...
  match update_tags_by_conditions(&mut conn, conditions, update_dto) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("UPDATE_TAG_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_delete_tag_by_id(
  ...
  match delete_tag(&mut conn, tag_id) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("DELETE_TAG_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_list_tags_by_conditions_with_pagination(
  ...
  let conditions: Vec<TagCondition> =
