...
use file_classification_core::service::files::{
  ...
  select_files_by_conditions_with_options, select_files_by_conditions_with_pagination,
  select_files_by_filter_with_options, select_files_by_filter_with_pagination, update_file_by_id,
};
...
async fn api_list_files_by_conditions_with_limit(
  ...
  // 调用服务层根据条件查询文件
  match select_files_by_conditions_with_limit(
    &mut conn,
...
async fn api_update_files_by_conditions(
  ...
  match update_files_by_conditions(&mut conn, conditions, update_dto) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("UPDATE_FILE_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_delete_file_by_id(
  ...
  match delete_file(&mut conn, file_id) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("DELETE_FILE_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_create_file(
  ...
  match create_file(&mut conn, file_dto) {
    ...
    Err(e) => Ok(
      HttpResponse::InternalServerError()
        .json(ApiResponse::<()>::error_with_code("CREATE_FILE_FAILED", &e.to_string())),
    ),
  }
}
...
async fn api_list_files_by_filter_with_pagination(
  ...
  let options: file_classification_core::model::models::FileQueryOptions =
...
async fn api_list_files_by_conditions_with_pagination(
  ...
  let conditions: Vec<FileCondition> =
