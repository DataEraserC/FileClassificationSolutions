...
use serde_json::json;
use file_classification_core::{model::models::{FileCondition, UpdateFileDTO, FileFilter}, service::files::{select_files_by_filter, select_files_by_conditions, update_files_by_conditions, delete_file}, utils};
use file_classification_core::service::files::{create_file, delete_files_by_conditions, select_file_by_group_id, select_files_by_conditions_with_options};
...
async fn api_list_files_by_conditions_with_options(
    query: web::Query<(Vec<FileCondition>, file_classification_core::model::models::FileQueryOptions)>,
    pool: web::Data<DbPool>,
) -> Result<HttpResponse> {
    // 解析查询参数
