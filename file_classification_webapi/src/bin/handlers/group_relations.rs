...
use serde_json::json;
use file_classification_core::{model::models::GroupRelationCondition, service::group_relations::{select_group_relations_by_conditions, create_group_relation, delete_group_relation}};
use file_classification_core::model::models::GroupRelation;
use file_classification_core::service::group_relations::{delete_group_relations_by_conditions, select_group_relations_by_conditions_with_options};
...
async fn api_list_group_relations_by_conditions_with_options(
    query: web::Query<(Vec<GroupRelationCondition>, file_classification_core::model::models::GroupRelationQueryOptions)>,
    pool: web::Data<DbPool>,
) -> Result<HttpResponse> {
    // 解析查询参数
